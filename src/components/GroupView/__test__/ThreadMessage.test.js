...
describe("ThreadMessage", () => {
    ...
    const authorEmail = "abc@gamil.com"
    const authorProfile = "https://flowbite.com/docs/images/people/profile-picture-2.jpg"
    const messageSubject = "Subject"
    const messageContent = "Content"
    const messageTime = "12:00 PM"
    const formattedDate = "2022-02-08"
    const haveReply = true
    ...
    const isFocusedRef = jest.fn()
    const toggle = jest.fn()
    

    it("should render ThreadMessage component with props", () => {
        ...
        const threadMessage = getByTestId("ThreadMessageTest");
